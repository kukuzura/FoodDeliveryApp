...
<html>
<head>
    <title>Customer company list</title>
    ...
    <div class="container"><a class="navbar-brand" href="#" style="color: rgb(227,227,227);">${company_name}</a>
        ...
        <div
            ...
            <ul class="nav navbar-nav ml-auto">
                <li role="presentation" class="nav-item"><a class="nav-link active" href="/customer_admin" style="color: #e3e3e3;">Список работников</a></li>
...
<form action="/create_customer_employee" method="get">
